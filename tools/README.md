...
- `acceptance.py --binary PATH` uses real source files in a temporary copy to check determinism, material and argument updates, and preservation of existing output after four error classes: syntax errors, routing errors, plugin failures, and missing results.
